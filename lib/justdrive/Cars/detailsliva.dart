...
class DetailslivaPage extends StatefulWidget {
  @override
  _DetailslivaPageState createState() => _DetailslivaPageState();
}

class _DetailslivaPageState extends State<DetailslivaPage> {
  @override
