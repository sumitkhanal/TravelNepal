...
class DetailsventoPage extends StatefulWidget {
  @override
  _DetailsventoPageState createState() => _DetailsventoPageState();
}

class _DetailsventoPageState extends State<DetailsventoPage> {
  @override
