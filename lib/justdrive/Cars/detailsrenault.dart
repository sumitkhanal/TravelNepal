...
class DetailsrenaultPage extends StatefulWidget {
  @override
  _DetailsrenaultPageState createState() => _DetailsrenaultPageState();
}

class _DetailsrenaultPageState extends State<DetailsrenaultPage> {
  @override
