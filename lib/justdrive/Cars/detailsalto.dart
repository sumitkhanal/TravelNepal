...
class DetailsaltoPage extends StatefulWidget {
  @override
  _DetailsaltoPageState createState() => _DetailsaltoPageState();
}

class _DetailsaltoPageState extends State<DetailsaltoPage> {
  @override
