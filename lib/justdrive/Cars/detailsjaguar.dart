...
class DetailsjaguarPage extends StatefulWidget {
  @override
  _DetailsjaguarPageState createState() => _DetailsjaguarPageState();
}

class _DetailsjaguarPageState extends State<DetailsjaguarPage> {
  @override
