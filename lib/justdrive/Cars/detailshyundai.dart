...
class DetailshyundaiPage extends StatefulWidget {
  @override
  _DetailshyundaiPageState createState() => _DetailshyundaiPageState();
}

class _DetailshyundaiPageState extends State<DetailshyundaiPage> {
  @override
