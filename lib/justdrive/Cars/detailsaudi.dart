...
class DetailsaudiPage extends StatefulWidget {
  @override
  _DetailsaudiPageState createState() => _DetailsaudiPageState();
}

class _DetailsaudiPageState extends State<DetailsaudiPage> {
  @override
