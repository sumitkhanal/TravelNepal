...
class DetailstataPage extends StatefulWidget {
  @override
  _DetailstataPageState createState() => _DetailstataPageState();
}

class _DetailstataPageState extends State<DetailstataPage> {
  @override
