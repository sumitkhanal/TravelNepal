...
class DetailssuzukiPage extends StatefulWidget {
  @override
  _DetailssuzukiPageState createState() => _DetailssuzukiPageState();
}

class _DetailssuzukiPageState extends State<DetailssuzukiPage> {
  @override
