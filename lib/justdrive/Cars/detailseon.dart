...
class DetailseonPage extends StatefulWidget {
  @override
  _DetailseonPageState createState() => _DetailseonPageState();
}

class _DetailseonPageState extends State<DetailseonPage> {
  @override
