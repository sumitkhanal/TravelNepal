...
class DetailsbmwPage extends StatefulWidget {
  @override
  _DetailsbmwPageState createState() => _DetailsbmwPageState();
}

class _DetailsbmwPageState extends State<DetailsbmwPage> {
  @override
