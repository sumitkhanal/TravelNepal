...
class DetailstoyotaPage extends StatefulWidget {
  @override
  _DetailstoyotaPageState createState() => _DetailstoyotaPageState();
}

class _DetailstoyotaPageState extends State<DetailstoyotaPage> {
  @override
